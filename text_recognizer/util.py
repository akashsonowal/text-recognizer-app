...
def read_image_pil_file(image_file, grayscale) -> Image:
...
def read_b64_string(b64_string, return_data_type=False): # b64_string is "data:data_type;base64,data"
...
def split_and_validate_b64_string(b64_string): # data:data_type;base64,data
